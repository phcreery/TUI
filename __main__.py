...
def intrusivekbd():
    ...
    # styles: default/modern, other
    r = tui.kbdinput("Prompt",screensize,"big","","WASD to Move     E to select    C for backspace    R/F to change KBD     Q to quit","defaultinput","modern")
...
def intrusivelist():
    ...
    t = tui.listselect("Select one:",screensize,options,"small","tooltip",getinput,"modern")
    print(t)

def options():
    options = ["first","second","third","fourth"]
    r = tui.prompt("title","Are you sure \nyou want to do this?",options,screensize,"tooltip",getinput,"old")
    print(options[r])
